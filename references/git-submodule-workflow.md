...
>
> **一屏总览状态、跨目录批量 fetch/pull/super、按组巡检 → 用 gita**，见 [gita-multi-repo.md](gita-multi-repo.md)；本篇只管原生 `git submodule`。
...
- 多仓总览/批量遥控工具 gita：<gita-multi-repo.md>，<https://github.com/nosarthur/gita>
- 初版整理 2026-09-14；2026-09-16 按上下文瘦身重组，gita 内容独立成篇。
